# Reconstrução da calculador de imposto de renda usando programação orientada a objeto

class TabelaIR():
    def __init__(self):
        self.tabela = tabela_ir = [
    {'faixa':(0 , 1903.98), 'aliquota': 0, 'deducao': 0},
    {'faixa':(1903.98, 2826.65), 'aliquota':7.5, 'deducao': 142.80},
    {'faixa':(2826.66, 3751.05), 'aliquota': 15, 'deducao': 354.80},
    {'faixa':(3571.06, 4664.68), 'aliquota': 22.5, 'deducao': 636.13},
